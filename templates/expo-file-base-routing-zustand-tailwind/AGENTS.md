...
src/
  app/                       ← Expo Router file-based routes
    _layout.tsx              ← root: ErrorBoundary + AuthGate + Toast
  ...
  store/
    appStore.ts              ← isAuthenticated · isHydrating
...
|-------|-----------|-------------|
| `useAppStore` | `isAuthenticated`, `isHydrating` | `setAuthenticated`, `setHydrating` |
